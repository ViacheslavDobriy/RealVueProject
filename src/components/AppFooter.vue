    ...
    <footer class="footer">
            <div class="footer__block">
                <div class="footer__logoBox">
                    ...
                    <a href="#" class="footer__titleLink">
                ...
                <div class="footer__social">
                    <a href="#">
                        <svg class="footer__svg" width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#">
                        <svg class="footer__svg" width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
