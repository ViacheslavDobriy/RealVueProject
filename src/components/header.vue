<template>
  <header class="header">
            <div class="header__logoBox">
                <svg class="header__logo" width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
...
$blackSiteColor: #292F36;
$grayColor: #4D5053;
$whiteColor: #FFF;
$goldSiteColor: #CDA274;
$lightGoldSiteColor: #F4F0EC; //svg
$centerWidth: 813.125px;
.header {
    display: flex;
    flex-direction: row;
